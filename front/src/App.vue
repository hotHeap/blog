                    ...
                    <section class = "section">
                        <div class = "content">
                            <div class = "location" v-show = "$route.name !== 'home'">
                                ...
                                <a href = "javascript: void(0)" @click = "backHome">homepage </a>
                                <div v-for = "item in location">
                                <b> >> </b><a href = "javascript: void(0)" @click = "back(item)"> {{ item.showName }}</a>
                                </div>
                            </div>
    ...
    components: {
      ...
      methods: {
        ...
        currentLocation: function(to){
          switch(to.name){
            case "article" : 
            this.location = [{pathName: "article",showName: " articles "}]
            break
            case "techincal" : 
            let tag = to.params.articleList
            this.location = [{pathName: "article",showName: " articles "},{pathName: "techincal",showName: tag,params: {tag: tag}}]
            break
            case "articleShow" : 
            let _tag = to.params.articleList
            this.location = [{pathName: "article",showName: " articles "},{pathName: "techincal",showName: _tag,params: {tag: _tag}},{pathName: "articleShow",showName: this.currentTitle,params: {tag: _tag,id: to.params.id}}]
            break
            case "life": 
            this.location = [{pathName: "life",showName: " for more "}]
            break
            case "lifeShow": 
            this.location = [{pathName: "life",showName: " for more "},{pathName: "lifeShow",showName: this.currentTitle,params: {id: to.params.id}}]
            console.log(this.currentTitle)
            break
            case "msgboard": 
            this.location = [{pathName: "msgboard",showName: "Message board"}]
            break
            case "search": 
            this.location = [{pathName: "search",showName: " search "}]
            break
            case "timeLine": 
            this.location = [{pathName: "timeLine",showName: " timeline "}]
          }
        }
      }
  }
